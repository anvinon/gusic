...
def song_genre():
    ...
    for a in range(1, 21) :
        path = root.xpath('//*[@id="content-area"]/div/div[2]/table/tbody/tr[{}]/td[1]/a'.format(a))
        ...
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[1]/a')
            ...
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[2]/a')
 
            Songs.objects.filter(title = t).update(genre2 = genre[0].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[3]/a')
            title = tree.xpath('//*[@id="content-header"]/h1')
            t = title[0].text
            ...
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[4]/a')
            Songs.objects.filter(title = t).update(genre4 = genre[0].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[5]/a')
            Songs.objects.filter(title = t).update(genre5 = genre[0].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[6]/a')
            Songs.objects.filter(title = t).update(genre6 = genre[0].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[7]/a')
            Songs.objects.filter(title = t).update(genre7 = genre[0].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[8]/a')
            Songs.objects.filter(title = t).update(genre2 = genre[8].text)
        except :
            pass
        try :
            genre = tree.xpath('//*[@id="node-64643"]/div/div[1]/div[2]/ul/li[9]/a')
